...
namespace Spells
{
    public class AatroxBasicAttack : ISpellScript
    {
        ...
        public void OnSpellPreCast(IObjAiBase owner, ISpell spell, IAttackableUnit target, Vector2 start, Vector2 end)
        {
            ...
            {
				spell.CastInfo.Owner.SetAutoAttackSpell("AatroxBasicAttack4", false);
			}
			else
			{
			}
    ...
    public class AatroxBasicAttack2 : ISpellScript
    {
        ...
        public void OnSpellPreCast(IObjAiBase owner, ISpell spell, IAttackableUnit target, Vector2 start, Vector2 end)
        {
			...
			if (owner.HasBuff("AatroxR"))
            {
				spell.CastInfo.Owner.SetAutoAttackSpell("AatroxBasicAttack5", false);
			}
			else
			{
			}
	...
	public class AatroxBasicAttack3 : ISpellScript
    {
        ...
        public void OnSpellPreCast(IObjAiBase owner, ISpell spell, IAttackableUnit target, Vector2 start, Vector2 end)
        {
			...
			if (owner.HasBuff("AatroxR"))
                    {
				    spell.CastInfo.Owner.SetAutoAttackSpell("AatroxBasicAttack6", false);
			        }
			        else
			        {
			        }	
            ...
            {
				OverrideAnimation(owner, "Spell2", "Attack3");
			}
			else
			{
				OverrideAnimation(owner, "Attack3", "Spell2");
			}
        }
