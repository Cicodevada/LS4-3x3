...
namespace Buffs
{
    internal class BlindMonkQTwoDash : IBuffGameScript
    {
        ...
        public void OnActivate(IAttackableUnit unit, IBuff buff, ISpell ownerSpell)
        {
            ...
            //ForceMovement(owner, target, "", dashSpeed, 0f, 0f, 0f, Vector2.Distance(target.Position, owner.Position), movementOrdersType: ForceMovementOrdersType.CANCEL_ORDER);
        ...
        {
            toRemove = true;
			StopAnimation(unit, "Spell1b", true, true, true);
        }
        ...
        public void OnMoveSuccess(IAttackableUnit unit)
        {
			...
			AddParticleTarget(owner, target, "blindMonk_Q_resonatingStrike_tar.troy", owner);          
            AddParticleTarget(owner, target, "blindMonk_Q_resonatingStrike_tar_blood.troy", owner);
            AddParticleTarget(owner, target, "blindMonk_Q_tar.troy", owner);	
            AddParticleTarget(owner, target, "GlobalHit_Yellow_tar", target);		
