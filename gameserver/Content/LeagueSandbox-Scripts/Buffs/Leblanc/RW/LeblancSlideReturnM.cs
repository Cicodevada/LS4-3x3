...
namespace Buffs
{
    class LeblancSlideReturnM : IBuffGameScript
    {
        ...
        public void OnActivate(IAttackableUnit unit, IBuff buff, ISpell ownerSpell)
        {
            ...
            {
                case 3:
                    particles = "LeBlanc_Base_RW_return_indicator.troy";
                    break;
            ...
            ApiEventManager.OnSpellCast.AddListener(this, LeBlanc.Owner.GetSpell("LeblancSlideReturnM"), W2OnSpellCast);
		...
		public void W2OnSpellCast(ISpell spell)
        {
            ...
            {
				LeBlanc.Owner.RemoveBuffsWithName("LeblancSlideM");
