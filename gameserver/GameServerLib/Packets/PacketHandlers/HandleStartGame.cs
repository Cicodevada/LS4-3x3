            ...
            else
            {
                ...
                if (_game.PlayersReady == _playerManager.GetPlayers().Count)
                {
                    ...
                    foreach (var player in _playerManager.GetPlayers())
                    {
                        ...
                        _game.PacketNotifier.NotifyS2C_HandleTipUpdatep((int)player.Item2.PlayerId, "Welcome to League of Legends do Cicao!",
                            "This is a WIP project.", "", 0, player.Item2.Champion.NetId,
                            _game.NetworkIdManager.GetNewNetId());
                        _game.PacketNotifier.NotifyS2C_HandleTipUpdatep((int)player.Item2.PlayerId, "Horario do server:",
                            ServerContext.BuildDateString, "", 0, player.Item2.Champion.NetId,
                            _game.NetworkIdManager.GetNewNetId());
                        _game.PacketNotifier.NotifyS2C_HandleTipUpdatep((int)player.Item2.PlayerId, "Tu ta de:",
